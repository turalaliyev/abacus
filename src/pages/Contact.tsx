...
export function Contact() {
  ...
  return (
    <>
      <PageHeader title="Əlaqə" subtitle="Suallarınız üçün bizimlə əlaqə saxlayın" />
      <section className="bg-white py-20 lg:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 lg:grid-cols-2 lg:px-8">
          <AnimatedSection>
            <h2 className="text-2xl font-bold text-navy-900">Bizə yazın</h2>
            <p className="mt-2 text-slate-600">
              Formu doldurun və komandamız ən qısa zamanda sizinlə əlaqə saxlasın.
            </p>
